...
HashTable | HashTable<String, Integer> map = new HashTable<>(); | put(key, value) | 	remove(Object key) | 	replace(K key, V value) | get(key) | size() | containsKey(Key) & containsValue(Object value)
